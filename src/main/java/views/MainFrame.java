...
public final class MainFrame extends javax.swing.JFrame implements View {
    ...
    public <T> void addCustomer(Customer c) {
        ...
        customerController.writeToFile(customers, DB_PATH + "customers.data");
    ...
    public void initCustomer() {
        customers = customerController.readFromFile(DB_PATH + "customers.data");
        initData(customers, customerTableModel);
    }
    ...
    public void addRoom(Room newRoom) {
        ...
        roomController.writeToFile(rooms, DB_PATH + "rooms.data");
        initRoom();
    }
    ...
    public void signRoom(Room room, Customer customer, Date rentDate) {
        ...
        roomController.writeToFile(rooms, DB_PATH + "rooms.data");
        customerController.writeToFile(customers, DB_PATH + "customers.data"); // sign will change customer rentDate;
    ...
    public void addEmployee(Employee e) {
        ...
        employeeController.writeToFile(employees, DB_PATH + "employees.data");
    ...
    public void addService(Service service) {
        ...
        serviceController.writeToFile(services, DB_PATH + "services.data");
        initService();
    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(40, 40, 40)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(refreshCustomerList, javax.swing.GroupLayout.PREFERRED_SIZE, 135, Short.MAX_VALUE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(findCustomerById, javax.swing.GroupLayout.DEFAULT_SIZE, 184, Short.MAX_VALUE))
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(checkoutRoom, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(displayRenter)
                    .addComponent(signRoom, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(60, 60, 60)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(displayOrderCustomer, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(removeOrderRoom, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(roomFilter, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(10, 10, 10)
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addComponent(jScrollPane4, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1145, Short.MAX_VALUE)
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(findEmployeeByName, javax.swing.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
                    .addComponent(employeeNameFilter))
                .addGap(43, 43, 43)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(employeeIdFilter)
                    .addComponent(findEmployeeById, javax.swing.GroupLayout.DEFAULT_SIZE, 174, Short.MAX_VALUE))
    ...
    public void initRoom() {
        rooms = roomController.readFromFile(DB_PATH + "rooms.data");
        initData(rooms, roomTableModel);
    }

    public void initEmployee() {
        employees = employeeController.readFromFile(DB_PATH + "employees.data");
        initData(employees, employeeTableModel);
    }

    public void initService() {
        services = customerController.readFromFile(DB_PATH + "services.data");
        initData(services, serviceTableModel);
    }
